<template>
  <Page title="Badge" desc="徽章" :padding="false">
    <weui-cell-group-title
      title="新消息提示跟摘要信息后，统一在列表右侧"
    ></weui-cell-group-title>
    <weui-cell-group>
      ...
      <weui-cell is-active>
        <template #label>
          <div style="position: relative; margin-right: 10px">
            ...
            />
            <weui-badge
              styleSet="position: absolute; top: -0.4em; right: -0.4em;"
              >8</weui-badge
            >
          </div>
        </template>
